    ...
    >
      ...
      <div className="form-row">
        ...
        <div className="form-group">
          ...
          <input list="category-options" name="category" value={formData.category} onChange={handleChange} placeholder="Select or type a category" />
      ...
      {formData.organiserComment !== undefined && (
        <div className="form-group">
          ...
          <textarea name="organiserComment" value={formData.organiserComment} onChange={handleChange} />
        </div>
      )}
